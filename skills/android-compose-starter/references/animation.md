...
Each automatically handles coroutines and recomposition. Always provide the `label` parameter — it is required for Animation Inspector in Android Studio and is treated as a best practice, not just a debugging hint.
